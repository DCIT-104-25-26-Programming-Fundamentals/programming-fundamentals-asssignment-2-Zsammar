...
double findAvg(const Student& student) {
...
//adds new student details to the list
void addStudent(vector<Student>& students) {
  Student newStudent;

  cin.ignore(); //removes unneeded newline
  cout << "Student name: ";
...
//displaying a formatted table of students, score and their averages.
void displayAllStudents(const vector<Student>& students) {
  ...
  cout << endl;
  cout << "Average Score: " << findAvg(student) << endl;
  }
  cout << "--------------------------------" << endl;
}


// using student ID to find and calculate their average score
void calculateAverageOfStudent(const vector<Student>& students) {
  int id;
  ...
  for (const Student& student : students) {
    if (student.id == id) {
      cout << fixed << setprecision(2);
      cout << student.name << "'s average score: " << findAvg(student) << endl;
      return;
    }
  }
